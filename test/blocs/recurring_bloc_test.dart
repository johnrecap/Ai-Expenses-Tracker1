...
void main() {
  ...
  group('RecurringExpenseBloc', () {
    test('initial state is empty', () {
      ...
      expect(bloc.state, isA<RecurringExpenseInitial>());
      bloc.close();
    });
    ...
    test('load populates items', () async {
      ...
      final bloc = RecurringExpenseBloc(repo, 'u1');
      bloc.add(const RecurringExpensesWatched());
...
class _MockRecurringRepo implements RecurringExpenseRepository {
  ...
  @override
  Future<void> create(RecurringExpense e) async {
    _items.add(e);
    _controller.add(_items);
  }

  @override
  Future<void> update(RecurringExpense e) async {}
  @override
  Future<void> delete(String id) async {}
  @override
  Future<List<RecurringExpense>> getAll() async => _items;
  @override
  Stream<List<RecurringExpense>> watchAll() => Stream.value(_items);
}
