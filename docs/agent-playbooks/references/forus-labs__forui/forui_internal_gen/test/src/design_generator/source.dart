...
class FGoldenStyle with Diagnosticable, _$FGoldenStyleFunctions {
  ...
  final FVariants<FGoldenVariantConstraint, FGoldenVariant, IconThemeData?, IconThemeDataDelta> nullableIconThemeDataVariants;
  final FVariants<FGoldenVariantConstraint, FGoldenVariant, TextStyle, TextStyleDelta> textStyleVariants;
  final FVariants<FGoldenVariantConstraint, FGoldenVariant, TextStyle?, TextStyleDelta> nullableTextStyleVariants;
