        ...
        TestScaffold(
          ...
          child: const FBottomNavigationBar(
            ...
            children: [
              ...
              FBottomNavigationBarItem(icon: Icon(FLucideIcons.radio), label: Text('Library')),
              FBottomNavigationBarItem(icon: Icon(FLucideIcons.radio), label: Text('Search')),
            ],
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        TestScaffold(
          ...
          child: const FBottomNavigationBar(
            index: 2,
            children: [
              FBottomNavigationBarItem(icon: Icon(FLucideIcons.house)),
              FBottomNavigationBarItem(icon: Icon(FLucideIcons.layoutGrid)),
              FBottomNavigationBarItem(icon: Icon(FLucideIcons.radio)),
              FBottomNavigationBarItem(icon: Icon(FLucideIcons.radio)),
              FBottomNavigationBarItem(icon: Icon(FLucideIcons.radio)),
            ],
          ),
