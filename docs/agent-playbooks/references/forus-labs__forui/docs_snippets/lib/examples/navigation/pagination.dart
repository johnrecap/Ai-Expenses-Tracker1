      ...
      next: Padding(
        ...
        child: ConstrainedBox(
          ...
          child: FButton.icon(
            ...
            child: IconTheme(data: style.itemIconStyle.base, child: const Icon(FLucideIcons.bird)),
          ),
        ),
      ),
      previous: Padding(
        ...
        child: ConstrainedBox(
          ...
          child: FButton.icon(
            ...
            child: IconTheme(data: style.itemIconStyle.base, child: const Icon(FLucideIcons.anchor)),
          ),
        ),
      ),
      // {@endhighlight}
