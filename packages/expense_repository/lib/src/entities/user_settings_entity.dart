...
class UserSettingsEntity {
  ...
  const UserSettingsEntity({
    required this.userId, this.appDisplayName, required this.languagePreference,
    required this.baseCurrency, required this.supportedCurrencies,
    required this.conversionRates, required this.defaultPaymentMethod,
    required this.notificationSettings, required this.onboardingCompleted,
    required this.onboardingVersion, required this.guidedTourCompletedVersion,
    required this.guidedTourSkippedVersion, this.guidedTourLastStepId,
    this.exchangeRatesUpdatedAt, required this.updatedAt,
  });
  ...
  Map<String, dynamic> toDocument() => {
    ...
    if (exchangeRatesUpdatedAt != null) 'exchangeRatesUpdatedAt': Timestamp.fromDate(exchangeRatesUpdatedAt!),
  ...
  static UserSettingsEntity fromDocument(Map<String, dynamic> data) {
    ...
    return UserSettingsEntity(
      ...
      conversionRates: Map<String, double>.from(
        (data['conversionRates'] as Map?)?.map((k, v) => MapEntry(k.toString(), (v as num).toDouble())) ?? {}),
